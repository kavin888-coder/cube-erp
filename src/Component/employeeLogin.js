...
const EmployeeLogin = () => {
  ...
  const handleLogin = () => {
    ...
    } else if (userId !== 'employee' || password !== 'password123') {
      ...
      <Grid container sx={{ flexGrow: 1, position: "relative", overflow: "hidden" }}>
          <Grid item xs={12} sx={{ width: "100%", height: "calc(100vh - 60px)", position: "relative" }}>
              ...
              <Grid container justifyContent="left" sx={{ml: 15 }}>
                  <Grid item>
                      <Box sx={{ zIndex: 1, width: "100%", maxWidth: "360px", background: "white", borderRadius: "24px", textAlign: "left",mt:8 }}>
                          ...
                          <Typography sx={{ fontWeight: "500", fontSize: "24px", color: "#333333", marginBottom: "20px", ml: 4 }}>Login as Employee</Typography>
                          ...
                          <Button
                              variant='contained'
                              onClick={handleLogin}
                              sx={{ width: "83%", height: "35px", ml: 4,mt:1, borderRadius: "12px", bgcolor: "#004E69", ":hover": { background: "#004E69" } }}
                          >
              ...
              <Grid container sx={{ 
                ...
                position: "fixed", 
                bottom: 0, 
                left: 0, // Ensure it spans the entire width of the page
                flexShrink: 0 
                }}>
                  <Grid item xs={12}>

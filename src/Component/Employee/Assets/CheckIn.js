...
const CheckIn = () => {
  ...
  const handleDoneClick = () => {
    if (!isAvatarUploaded) {
      setAlertDialogOpen(true); // Open the alert dialog if the avatar is not uploaded
    } else {
      ...
      <Box sx={{ width: "100%", height: "100%" }}>
        ...
        >
          ...
          <Dialog open={alertDialogOpen} onClose={handleAlertDialogClose}>
            ...
            <DialogContent>Please upload your profile picture before proceeding.</DialogContent>
            <DialogActions>
          ...
          <Dialog open={dialogOpen} onClose={handleDialogClose}>
            ...
            <DialogContent>Your check-in has been recorded successfully.</DialogContent>
            <DialogActions>

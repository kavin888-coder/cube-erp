...
import { Box, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, Pagination, Paper, Grid, Dialog, Button } from '@mui/material';
...
const EmployeeTasks = () => {
  ...
  const [searchTerm] = useState(''); // State for search input

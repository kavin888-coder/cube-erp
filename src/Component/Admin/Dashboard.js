...
const Dashboard = () => {
  ...
  const card = [
    { id: 1, num: 250, ty1: "Total no of staffs", ty2: "12 more than etc...", icon: <PeopleIcon sx={{ height: "35px", width: "50px" ,color:'#F29425'}} />,col:"#FFF4E8",icon2:<ArrowUpwardIcon/> ,fun:handleStaffClick},
    { id: 2, num: 250, ty1: "Total Projects", ty2: "12 more than etc...", icon: <FileCopyIcon sx={{ height: "35px", width: "50px",color:'#248CD8' }} />,col:"#E8F5FF",icon2:<ArrowUpwardIcon/> ,fun:handleProjectClick },
    { id: 3, num: 250, ty1: "Ongoing Projects", ty2: "12 more than etc...", icon: <RocketLaunchIcon sx={{ height: "35px", width: "50px",color:"#A601FF" }} />,col:"#F9EFFF",icon2:<ArrowUpwardIcon/>,fun:handleTeamClick },
    { id: 4, num: 250, ty1: "Total Departments", icon: <ReduceCapacityIcon sx={{ height: "35px", width: "50px",color:"#10A142" }} />,col:"#ECFFF2",fun:handleTeamClick}
  ...
  return (
    <Grid container  bgcolor={'#E5F1FF'}>
      ...
      <Typography variant='h4' fontWeight={'bold'} color={'#004E69'} marginLeft={2}>Dashboard</Typography>
        <Grid container spacing={2}  rowGap={4} sx={{ padding: 2 }}   >
       
          {card.map((card) => (
            <Grid item lg={3} md={6} sm={6} xs={12} key={card.id} flexWrap={'wrap'}>
              <Card sx={{ minWidth: "250px", minHeight: "150px", borderRadius: '15px', margin: "10px", cursor: "pointer" }} onClick={card.fun} >
                <CardContent>

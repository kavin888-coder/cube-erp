...
const Side = () => {
  ...
  const Pages = [
    ...
    { id: 1, icon: <SpeedIcon />, icName: "Dashboard", path: "/admindashboard" },
    { 
      id: 2, 
      icon: <PeopleIcon />, 
      icName: "Employees", 
    ...
    { id: 3, icon: <HowToRegOutlinedIcon />, icName: "Attendence", path: "/adminattendence" },
    { id: 4, icon: <TaskIcon />, icName: "Tasks", path: "/admintask" },
    { id: 5, icon: <GroupsIcon />, icName: "Team", path: "/adminteam" },
    { id: 6, icon: <PersonIcon />, icName: "Profile", path: "/adminprofile" },
    { id: 7, icon: <SettingsIcon />, icName: "Settings", path: "/adminsettings" },
  ];

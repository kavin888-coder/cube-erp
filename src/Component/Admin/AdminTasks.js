...
import { Modal,Box, Button, Card, FormControl, InputAdornment, InputLabel, OutlinedInput, Select, MenuItem, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, TextField, Divider, Pagination, Paper, Grid } from '@mui/material';
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        {paginatedData.map((row, index) => (
                                            ...
                                            <TableCell sx={{ borderBottom:"none" }}><Typography sx={{ fontWeight: "500", fontSize: "14px", lineHeight: "24px", color: "#515151" }}>{row.name}</Typography></TableCell>
                                            <TableCell sx={{ borderBottom:"none" }}><Typography sx={{ fontWeight: "500", fontSize: "14px", lineHeight: "24px", color: "#515151" }}>{row.gender}</Typography></TableCell>
                                            <TableCell sx={{ borderBottom:"none" }}><Typography sx={{ fontWeight: "500", fontSize: "14px", lineHeight: "24px", color: "#515151" }}>{row.staffId}</Typography></TableCell>
                                            ...
                                            <TableCell sx={{ borderBottom:"none" }}><Typography sx={{ fontWeight: "500", fontSize: "14px", lineHeight: "24px", color: "#515151" }}>{row.role}</Typography></TableCell>
                                            ...
                                            <TableCell sx={{ borderBottom:"none" }}><Typography sx={{ fontWeight: "500", fontSize: "14px", lineHeight: "24px", color: row.tasks==='In progress'?"#FEB634":row.tasks==="Completed"?"#3FC28A":row.tasks==='Yet to Start'?"#2596BE":row.tasks==='In Validation'?"#004E69":"black" }}>{row.tasks}</Typography></TableCell>
                                            <TableCell sx={{ borderBottom:"none" }}><Typography sx={{ fontWeight: "500", fontSize: "14px", lineHeight: "24px", color: "#004E69"}}>{row.action}</Typography></TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                                </Table>
